...
CURRENT_LLVM_STABLE=18 # JW
# CURRENT_LLVM_STABLE=19   # JW
...
LLVM_VERSION_PATTERNS[19]="-19" # JW
LLVM_VERSION_PATTERNS[20]=""    # JW
...
if [[ $ALL -eq 1 ]]; then
    ...
    # PKG="$PKG clang-tidy-$LLVM_VERSION clang-format-$LLVM_VERSION clang-tools-$LLVM_VERSION llvm-$LLVM_VERSION-dev lld-$LLVM_VERSION lldb-$LLVM_VERSION llvm-$LLVM_VERSION-tools libomp-$LLVM_VERSION-dev libc++-$LLVM_VERSION-dev libc++abi-$LLVM_VERSION-dev libclang-common-$LLVM_VERSION-dev libclang-$LLVM_VERSION-dev libclang-cpp$LLVM_VERSION-dev libunwind-$LLVM_VERSION-dev flang-$LLVM_VERSION-dev"
    # if test $LLVM_VERSION -gt 14; then
    #     PKG="$PKG libclang-rt-$LLVM_VERSION-dev libpolly-$LLVM_VERSION-dev"
    # fi
    PKG="$PKG clang-tidy-$LLVM_VERSION clang-format-$LLVM_VERSION clang-tools-$LLVM_VERSION llvm-$LLVM_VERSION lld-$LLVM_VERSION lldb-$LLVM_VERSION llvm-$LLVM_VERSION-tools libomp-$LLVM_VERSION libc++-$LLVM_VERSION libc++abi-$LLVM_VERSION libclang-common-$LLVM_VERSION libclang-$LLVM_VERSION libclang-cpp$LLVM_VERSION libunwind-$LLVM_VERSION flang-$LLVM_VERSION"
    if test $LLVM_VERSION -gt 14; then
        PKG="$PKG libclang-rt-$LLVM_VERSION libpolly-$LLVM_VERSION"
    fi
fi
